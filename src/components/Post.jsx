          ...
          if (contentBlock.type === 'text') {
            ...
            const heading =
              contentBlock.isSubHeading === false ? ( // determine which heading should be used
                <h3 className="postHeading">{contentBlock.heading}</h3>
              ) : (
                <h4 className="postSubHeading">{contentBlock.heading}</h4>
              )
            ...
            return <div className="contentBlock imageBlock" key={index}></div>
          } else if (contentBlock.type === 'iFrame') {
            return <div className="contentBlock iFrameBlock" key={index}></div>
          } else if (contentBlock.type === 'orderedList') {
            return <div className="contentBlock oListBlock" key={index}></div>
          } else if (contentBlock.type === 'unOrderedList') {
            return <div className="contentBlock uListBlock" key={index}></div>
          }
        })}
      </div>
    </div>
